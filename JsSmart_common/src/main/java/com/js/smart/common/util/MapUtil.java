...
//            slon = originLatLng.longitude;
     ...
     * 打开谷歌地图导航功能
     */
    public static void openGoogleNavi(Context context, double mLatitude, double mLongitude) {
